...
DB_HOST = os.getenv("DB_HOST", "pg-3282bb18-maxk-project1.k.aivencloud.com")
DB_PORT = os.getenv("DB_PORT", "17444")
DB_NAME = os.getenv("DB_NAME", "defaultdb")
DB_USER = os.getenv("DB_USER", "avnadmin")
DB_PASSWORD = os.getenv("DB_PASSWORD", "youpass")
...
# Створення таблиць (при необхідності)
...
def test_connection():
    try:
        with engine.connect() as connection:
            return jsonify({"message": "Connection to the database is successful!"})
